...
function update_booking_details($v_id, $d_id, $end_date, $start_time, $end_time, $custom_rate, $b_id)
{
    global $con;
    global $res;
    ...
    try {
        ...
        $sql  = "UPDATE bookings SET vehicle_id = ?, driver_id = ?, end_date = ?, start_time = ?, end_time = ?, custom_rate = ? WHERE id = ?";
        $stmt = $con->prepare($sql);
        if ($stmt->execute([$v_id, $d_id, $end_date, $start_time, $end_time, $custom_rate, $b_id])) {
            $res = "Success";
        } else {
            $res = "No Success";
        }
...
function custom_booking_update($v_id, $d_id, $end_date, $start_time, $end_time, $custom_rate, $total, $b_id)
{
    global $con;
    global $res;
    ...
    try {
        $con->beginTransaction();
        $sql  = "UPDATE bookings SET vehicle_id = ?, driver_id = ?, end_date = ?, start_time = ?, end_time = ?, custom_rate = ?, total = ? WHERE id = ?";
        $stmt = $con->prepare($sql);
        if ($stmt->execute([$v_id, $d_id, $end_date, $start_time, $end_time, $custom_rate, $total, $b_id])) {
            $res = "Success";
        } else {
            $res = "No Success";
        }
