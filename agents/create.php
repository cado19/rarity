<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $details = [$name, $email, $country, $tel, $hashed_password, $role_id];
        ...
        if ($result != "Failed") {
            ...
            $id = $result;
            create_suv_rate($id);
            create_mid_size_suv_rate($id);
            create_medium_car_rate($id);
            create_small_car_rate($id);
            create_safari_rate($id);
            create_luxury_rate($id);
            create_commercial_rate($id);
