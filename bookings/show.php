                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="post">
                                      ...
                                      <!-- /.user-block -->
                                      <p>
                                        The<?php echo " "; ?><?php echo $booking['model']; ?><?php echo " "; ?><?php echo $booking['make']; ?> is a<?php echo " "; ?><?php echo $booking['drive_train']; ?><?php echo " "; ?><?php echo $booking['category']; ?> loved by many. It can carry<?php echo " "; ?><?php echo $booking['seats']; ?>
                                        people. The hire rate is<?php echo " "; ?><?php echo number_format($booking['daily_rate']); ?>.
                                      </p>
